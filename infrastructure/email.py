...
def get_hacker_rsvp_request_template(first_name, application_id):
    ...
    return "RSVP to Reality Hack at MIT 2026 and Secure Your Spot", (
        f"Hi there {first_name},"
        "\n\n"
        "We're so excited for you to join us as a hacker at Reality Hack 2026. At this time, please RSVP on our event portal by following this unique, personalized link to submit your RSVP to us."
        "\n\n"
        ...
        "\n\n"
        "We're looking forward to welcoming you in January. Until then, make sure you have joined our Discord here: https://discord.gg/uHyVvCQmdc so that you stay up-to-date with us. During the event, we will be centralizing all communications on Discord. Please submit your RSVP by January 5, 2026 to secure your spot or we will release your spot to someone on our waitlist."
        "\n\n"
        "Let us know on Discord if you're having issues with the RSVP or email us back at apply@realityhackinc.org!"
        "\n\n"
        "See you soon,"
        "\n\n"
        "Reality Hack Organizing Team"
...
def get_mentor_rsvp_request_template(first_name, application_id):
    ...
    return "RSVP to Reality Hack at MIT 2026", (
        f"Hi there {first_name},"
        "\n\n"
        "We're so excited for you to join as a mentor at Reality Hack 2026. At this time, please RSVP on our event portal by following this unique, personalized link to submit your RSVP to us."
        "\n\n"
        "When you get to the Discord username question, please double and triple check you've entered your correct Discord username."
        "\n\n"
        f"{request_uri}"
...
def get_judge_rsvp_request_template(first_name, application_id):
    ...
    return "RSVP to Reality Hack at MIT 2026", (
        f"Hi there {first_name},"
        "\n\n"
        "We're so excited for you to join as a judge at Reality Hack 2026. At this time, please RSVP on our event portal by following this unique, personalized link to submit your RSVP to us."
        "\n\n"
        f"{request_uri}"
        "\n\n"
        "We're looking forward to welcoming you in January."
        "\n\n"
        "Let us know if you're having issues with the RSVP by emailing us at apply@realityhackinc.org! Stay tuned for more communications from us regarding the schedule of the judging day."
        "\n\n"
        "See you soon,"
        "\n\n"
        "Reality Hack Organizing Team"
