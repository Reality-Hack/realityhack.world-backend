...
def get_hacker_rsvp_request_template(first_name, application_id):
    ...
    return "RSVP to MIT Reality Hack 2025 and Secure Your Spot", (
        ...
        "\n\n"
        "We're looking forward to welcoming you in January. Until then, make sure you have joined our Discord here: https://discord.gg/uHyVvCQmdc so that you stay up-to-date with us. During the event, we will be centralizing all communications on Discord. Please submit your RSVP by December 30, 2024 to secure your spot or we will release your spot to someone on our waitlist."
        "\n\n"
