# Generated by Django 4.2.2 on 2023-12-07 16:03
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('infrastructure', '0003_alter_application_current_country_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.CharField(choices=[('P', 'Participant'), ('M', 'Mentor'), ('J', 'Judge')], default='P', max_length=1),
        ),
        migrations.AlterField(
            model_name='application',
            name='age_group',
            field=models.CharField(choices=[('A', '17 or younger'), ('B', '18 to 20'), ('C', '21 to 29'), ('D', '30 to 39'), ('E', '40 to 49'), ('F', '50 to 59'), ('G', '60 or older'), ('H', 'I prefer not to say')], default='H', max_length=1, null=True),
        ),
        migrations.AlterField(
            model_name='application',
            name='current_city',
        ...
        migrations.AlterField(
            ...
            field=models.CharField(choices=[('S', 'Student'), ('P', 'Professional'), ('H', 'Hobbyist')], default='H', max_length=1, null=True),
        ),
        migrations.AlterField(
            model_name='application',
        ...
        migrations.AlterField(
            model_name='application',
            name='resume',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='application_resume_uploaded_file', to='infrastructure.uploadedfile'),
        ),
    ]
